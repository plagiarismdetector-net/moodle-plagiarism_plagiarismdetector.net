...
class plagiarism_receipt_message
{
    ...
    public function send_message($userid, $message, $courseid)
    {
        ...
        $subject = get_string('digital_receipt_subject', 'plagiarism_pd');

        $eventdata = new \core\message\message();
        $eventdata->component = 'plagiarism_pd'; // Your component name.
    ...
    public function build_message($input)
    {
        ...
        return format_text(get_string('digital_receipt_message', 'plagiarism_pd', $message));
    }
}
